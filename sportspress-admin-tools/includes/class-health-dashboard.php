...
class SPAT_Health_Dashboard
{
    ...
    private function render_plugin_status()
    {
        ...
        $child_plugins = array(
            'sportspress-etransfer-automation/sportspress-etransfer-automation.php' => array('name' => 'e-Transfer Automation', 'module' => 'etransfer_automation'),
            'sportspress-schedule-generator/sportspress-schedule-generator.php' => array('name' => 'Schedule Generator', 'module' => 'league_schedule_generator'),
            'sportspress-player-tools/sportspress-player-tools.php' => array('name' => 'Player Tools', 'module' => 'player_modifications'),
            'sportspress-player-registration/sportspress-player-registration.php' => array('name' => 'Player Registration', 'module' => 'player_registration'),
            'sportspress-league-manager/sportspress-league-manager.php' => array('name' => 'League Manager', 'module' => 'league_manager_dashboard'),
            'sportspress-events-manager/sportspress-events-manager.php' => array('name' => 'Events Manager', 'module' => 'events_management'),
        );
    ...
    private function render_config_warnings()
    {
        ...
        if (class_exists('SportsPress')) {
            $leagues = get_terms(array('taxonomy' => 'sp_league', 'hide_empty' => false, 'number' => 1));
            if (empty($leagues) || is_wp_error($leagues)) {
                $warnings[] = __('No SportsPress leagues configured.', 'sportspress-admin-tools');
            }
            $seasons = get_terms(array('taxonomy' => 'sp_season', 'hide_empty' => false, 'number' => 1));
