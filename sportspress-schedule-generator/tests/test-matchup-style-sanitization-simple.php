<?php
/**
 * Simple Test for Matchup Style Sanitization
 * 
 * Loads WordPress directly from local installation
 * 
 * @author Cody (lusky3)
 */
...
require_once('/home/cody/arl-local/wp-load.php');

// Load plugin classes
require_once(dirname(__DIR__) . '/includes/class-autoloader.php');
require_once(dirname(__DIR__) . '/includes/interfaces/interface-configuration.php');
require_once(dirname(__DIR__) . '/includes/class-schedule-configuration.php');
require_once(dirname(__DIR__) . '/includes/class-configuration-manager.php');
