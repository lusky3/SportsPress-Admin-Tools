    ...
    public function export($schedule, $config = null)
    {
        ...
        try {
            ...
            foreach ($headers as $header) {
                ...
                $sheet->getStyle($col . '1')->getAlignment()->setVertical(\PhpOffice\PhpSpreadsheet\Style\Alignment::VERTICAL_CENTER);
                $col++;
            }
            ...
            $sheet->getColumnDimension('B')->setWidth(10); // Start Time
            $sheet->getColumnDimension('C')->setWidth(10); // End Time
            $sheet->getColumnDimension('D')->setWidth(10); // Duration
            $sheet->getColumnDimension('I')->setWidth(25); // Home/Away
            $sheet->getColumnDimension('J')->setWidth(12); // Inter-Division
            $sheet->getColumnDimension('K')->setWidth(10); // Type
            $sheet->getColumnDimension('L')->setWidth(8); // Week
