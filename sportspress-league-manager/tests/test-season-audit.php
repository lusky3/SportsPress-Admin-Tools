...
assert_test( $audit::is_stale_range( 'range', '2025-09-29', '2026-04-24' ), 'a range ending before the season starts is stale' );
assert_test( ! $audit::is_stale_range( '0', '2025-09-29', '2026-04-24' ), 'mode 0 (all dates) is never stale, whatever the stored dates say' );
assert_test( ! $audit::is_stale_range( '', '2025-09-29', '2026-04-24' ), 'an empty mode is not stale' );
assert_test( ! $audit::is_stale_range( 'range', '2026-08-28', '2026-04-24' ), 'a range covering the season is not stale' );
assert_test( ! $audit::is_stale_range( 'range', '2026-04-24', '2026-04-24' ), 'a range ending exactly on the first game day is not stale' );
assert_test( ! $audit::is_stale_range( 'range', '2027-01-01', '2026-04-24' ), 'a future range is not stale' );
assert_test( ! $audit::is_stale_range( 'range', '', '2026-04-24' ), 'an empty end date is not stale, there is nothing to compare' );
assert_test( ! $audit::is_stale_range( 'range', '2025-09-29', '' ), 'an unknown season start never flags anything, rather than guessing' );
